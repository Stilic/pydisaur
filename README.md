...
4. For launch it, type in your terminal `python3 main.py [PORT or leave empty for port 5000] [true or false if your app use http or no]` and go to the given address.
